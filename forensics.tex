...
\tikzstyle{process} = [rectangle, minimum width=3cm, minimum height=1cm, text centered, draw=black, fill=orange!30, text width=0.95\linewidth]
\tikzstyle{decision} = [diamond, minimum width=4cm, minimum height=4cm, text centered, draw=black, fill=green!30, text width= 4cm ]
...
\begin{document}
	...
	\section{Fonti normative}
		...
		\node (pro2) [process, below of=dec1, yshift=-8cm, text width=3.5cm] {NON ACCENDERLO!};
		
		\node (pro3) [process, below of=dec2, text width=3.5cm,  yshift=-8cm] {Seguire i suoi consigli};
		
		\node (pro4) [process, left of=pro3, text width=4cm, xshift=-3cm, yshift=6cm] {Non accettare consigli da sedicenti esperti};
		...
		\subsection{Un caso di studio: esiste la ``perquisizione informatica''?}
	...
	\section{L'analisi forense}
		...
		\subsection{I principi base dell'analisi forense}
