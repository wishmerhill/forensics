...
\begin{document}
	...
	\subsection{Fonti normative}
		...
		\begin{enumerate}
			\item il repertamento dell'oggetto fisico, che mantiene i dati seguendo un qualche principio fisico (in genere elettrico, magnetico e/o ottico);
			\item il repertamento dei dati ossia la fedele copia dei dati su supporto sicuro.
		\end{enumerate}
		...
		Di questa ?analisi delle priorità? dovremo tenere conto sia in fase di sopralluogo e quindi di raccolta del materiale, sia in fase di esame tecnico forense.
