	...
	\section{L'analisi forense}
		...
		\subsection{L'analisi \textit{post mortem}}
			...
			\subsubsection{I software per l'analisi forense}
				...
				Il parere di chi scrive è che, soprattutto la pubblica amministrazione e le forze di polizia dovrebbero, per quanto possibile, tendere all'utilizzo di software non commerciale possibilmente libero (e quindi a sorgente aperto). Sullo specifico argomento, ovviamente, la questione è molto dibattuta e tende a essere più una dissertazione filosofica che una pragmatica presa di posizione ed esula decisamente dallo scopo della presente trattazione.
			...
			\subsubsection{La copia forense}
				...
				\paragraph{Perché è necessario proteggere dalla scrittura i supporti prima di copiarli?} I sistemi operativi moderni, qualsiasi essi siano, a meno di non venire configurati \textit{ad hoc}, 
