...
\begin{document}
	...
	\section{L'analisi forense}
		...
		\subsection{L'analisi \textit{post mortem}}
			...
			\subsubsection{I software per l'analisi forense}
			...
			\subsubsection{La copia forense}
				...
				\begin{itemize}
					...
					\item utilizzare come sistema di analisi una workstation con a bordo un sistema operativo specificamente pensato per le analisi forensi -- al riguardo, nel seguito, ne verranno presentati alcuni.
				\end{itemize}
				...
				Ormai tutti i software che permettono di creare immagini forensi hanno la funzionalità automatica per la generazione dell'\textit{hash}, proponendo di solito oltre al classco e superato MD5 anche SHA1 o SHA256.
