...
%					\end{tikzpicture}
	...
	\begin{frame}
		...
		\textbf{Nota:} 
		\begin{itemize}
			\item questa presentazione è stata realizzata \LaTeX;
			\item il materiale di questa lezione è disponibile in formato sorgente \LaTeX all'indirizzo \url{https://github.com/wishmerhill/forensics/}.
		\end{itemize}
